...
class LangsTest extends TestCase
{
     ...
     * @var string
     */
    protected string $endpoint = 'front/langs';
     ...
     * @return void
     */
    public function test_front_langs()
    {
        $this->getHttpMethod();
    }
     ...
     * @return void
     */
    public function test_front_langs_post_required_columns()
    {
     ...
     * @return void
     */
    public function test_front_langs_post()
    {
        $this->postHttpMethod();
    }
     ...
     * @return void
     */
    public function test_front_langs_put()
    {
        $this->putHttpMethod();
    }
     ...
     * @return void
     */
    public function test_front_langs_put_activation()
    {
     ...
     * @return void
     */
    public function test_front_langs_put_activation2()
    {
     ...
     * @return void
     */
    public function test_front_langs_put_activation3()
    {
     ...
     * @return void
     */
    public function test_front_langs_put_activation4()
    {
     ...
     * @return void
     */
    public function test_front_langs_put_activation5()
    {
     ...
     * @return void
     */
    public function test_front_langs_put_activation6()
    {
     ...
     * @return void
     */
    public function test_front_langs_put_activation7()
    {
        $this->putHttpMethodActivation(['status' => true,'is_deleted' => false],1);
    }
}
