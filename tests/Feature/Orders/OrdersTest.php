...
class OrdersTest extends TestCase
{
     ...
     * @var string
     */
    protected string $repository = 'order';
     ...
     * @return void
     */
    public function test_orders_post_required_columns()
    {
     ...
     * @return void
     */
    public function test_orders_post()
    {
        $this->postHttpMethod();
    }
     ...
     * @return void
     */
    public function test_orders_put()
    {
        $this->putHttpMethod();
    }
     ...
     * @return void
     */
    public function test_orders_put_activation()
    {
     ...
     * @return void
     */
    public function test_orders_put_activation2()
    {
     ...
     * @return void
     */
    public function test_orders_put_activation3()
    {
     ...
     * @return void
     */
    public function test_orders_put_activation4()
    {
     ...
     * @return void
     */
    public function test_orders_put_activation5()
    {
     ...
     * @return void
     */
    public function test_orders_put_activation6()
    {
     ...
     * @return void
     */
    public function test_orders_put_activation7()
    {
        $this->putHttpMethodActivation(['status' => true,'is_deleted' => false],1);
    }
}
