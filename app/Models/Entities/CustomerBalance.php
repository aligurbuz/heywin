 ...
 * @property $this customer_balance_code
...
class CustomerBalance
{
	...
	/**
	 * get customer_balance_code column for database table
	 *
	 * @return mixed
	 */
	protected static function customer_balance_code(): mixed
	{
		return self::$query->customer_balance_code;
	}
